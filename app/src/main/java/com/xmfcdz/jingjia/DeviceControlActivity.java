    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                //显示services的UUID、characteristics的UUID
                btnSend.setEnabled(true);
                //displayGattServices(mBluetoothLeService.getSupportedGattServices());
                Log.e("dis","discovered");
...
//            BluetoothGattService bts = mBluetoothLeService.getmBluetoothGatt().getService(BluetoothLeService.UUID_SERVICE);
//            Log.e("bts",bts.toString());
//            BluetoothGattCharacteristic btc = bts.getCharacteristic(BluetoothLeService.UUID_NOTIFY);
//            Log.e("btc",btc.toString());
//            if ((btc.getProperties() | BluetoothGattCharacteristic.PROPERTY_READ) > 0) {
//                mBluetoothLeService.readCharacteristic(btc);
//            }
//
//        }
//    }
    ...
    public void WriteValue(String strValue)
    {
        BluetoothGattService bts = mBluetoothLeService.getmBluetoothGatt().getService(BluetoothLeService.UUID_SERVICE);
        BluetoothGattCharacteristic btc = bts.getCharacteristic(BluetoothLeService.UUID_NOTIFY);
        mNotifyCharacteristic = btc;
        mNotifyCharacteristic.setValue(strValue.getBytes());
        mBluetoothLeService.getmBluetoothGatt().writeCharacteristic(mNotifyCharacteristic);
    }
    @Override
    ...
    class ClickEvent implements View.OnClickListener {
        ...
        public void onClick(View v) {
            if (v == btnSend) {
                ...
                WriteValue(edtSend.getText().toString());
